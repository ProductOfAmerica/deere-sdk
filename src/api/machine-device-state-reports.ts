...
export class MachineDeviceStateReportsApi {
   ...
   */
  async get(principalId: string, params?: { lastKnown?: boolean; startDate1?: string; endDate1?: string }, options?: RequestOptions): Promise<PaginatedResponse<components['schemas']['DeviceStateReport']>> {

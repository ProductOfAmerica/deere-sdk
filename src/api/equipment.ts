...
export class EquipmentApi {
  ...
  /**
   * Get equipment
   * @description This resource allows the client to view the list of a user's
   * equipment. It can be called with a filter for specific organizations,
   * machine or implement types, but can also be called without a filter to
   * provide a list of all equipment accessible by the user across each
   * organization the user has access to. Equipment will only be returned from
   * organizations the user has access to and are connected to the calling
   * application. If the client requests multiple organizations in the filter,
   * and a user or the client does not have access to that organization, the
   * entire response will be a 403 Forbidden. Please see the OAuth 2
   * documentation for more details on obtaining a user token and connecting the
   ...
   * @description This resource allows the client to view the details of one
   * piece of equipment.
  ...
  /**
   * Update equipment
   * @description This resource allows the client to update a piece of equipment
   * within a user’s organization. Clients will only be able to update a piece
   * of equipment that was contributed via the POST /equipment API. John Deere
   * controlled equipment can only be managed via the Equipment application in
   * Operations Center.
  ...
  /**
   * Delete equipment
   * @description This resource allows the client to delete a piece of equipment
   * within a user’s organization. Clients will only be able to delete a piece
   * of equipment that was contributed via the POST /equipment API. John Deere
   * controlled equipment can only be managed via the Equipment application in
   * Operations Center.
  ...
  /**
   * Get equipment makes
   * @description This resource allows the client to view equipment makes and
   ...
   * @description This resource allows the client to view equipment makes by an
   * equipment make ID.
   ...
   * @description This operation retrieves a list of Equipment ISG Types for
   * given makeId.
   ...
   * @description This operation retrieves a single Equipment ISG Type for given
   ...
   * @description This operation retrieves a list of Equipment Models based on
   ...
   * @description This operation retrieves a single Equipment Model based on
